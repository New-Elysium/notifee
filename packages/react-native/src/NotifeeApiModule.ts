...
export function getNotificationConfig(): NotificationConfig {
  return {
    ...notificationConfig,
    ios: notificationConfig.ios ? { ...notificationConfig.ios } : undefined,
  };
}
...
export default class NotifeeApiModule extends NotifeeNativeModule implements Module {
  ...
  public getTriggerNotifications = (): Promise<TriggerNotification[]> => {
    if (isAndroid || isIOS) {
      return this.native.getTriggerNotifications() as unknown as Promise<TriggerNotification[]>;
    }
  ...
  public getDisplayedNotifications = (): Promise<DisplayedNotification[]> => {
    if (isAndroid || isIOS) {
      return this.native.getDisplayedNotifications() as unknown as Promise<DisplayedNotification[]>;
    }
  ...
  public getChannel = (channelId: string): Promise<NativeAndroidChannel | null> => {
    ...
    if (isAndroid && this.native.getConstants().ANDROID_API_LEVEL >= 26) {
      return this.native.getChannel(channelId) as unknown as Promise<NativeAndroidChannel | null>;
    }
  ...
  public getChannels = (): Promise<NativeAndroidChannel[]> => {
    if (isAndroid && this.native.getConstants().ANDROID_API_LEVEL >= 26) {
      return this.native.getChannels() as unknown as Promise<NativeAndroidChannel[]>;
    }
  ...
  public getChannelGroup = (channelGroupId: string): Promise<NativeAndroidChannelGroup | null> => {
    ...
    if (isAndroid && this.native.getConstants().ANDROID_API_LEVEL >= 26) {
      return this.native.getChannelGroup(
        channelGroupId,
      ) as unknown as Promise<NativeAndroidChannelGroup | null>;
    }
  ...
  public getChannelGroups = (): Promise<NativeAndroidChannelGroup[]> => {
    if (isAndroid && this.native.getConstants().ANDROID_API_LEVEL >= 26) {
      return this.native.getChannelGroups() as unknown as Promise<NativeAndroidChannelGroup[]>;
    }
  ...
  public getInitialNotification = (): Promise<InitialNotification | null> => {
    if (isIOS || isAndroid) {
      return this.native.getInitialNotification() as unknown as Promise<InitialNotification | null>;
    }
  ...
  public requestPermission = (
    ...
    if (isAndroid) {
      return this.native.requestPermission({}).then(({ authorizationStatus, android }: any) => {
        return {
          authorizationStatus,
          android,
          ios: {
    ...
    if (isIOS) {
      ...
      return this.native.requestPermission(options).then(({ authorizationStatus, ios }: any) => {
        return {
          authorizationStatus,
          ios,
          android: {
  ...
  public getNotificationCategories = (): Promise<IOSNotificationCategory[]> => {
    ...
    return this.native.getNotificationCategories() as unknown as Promise<IOSNotificationCategory[]>;
  };

  public getNotificationSettings = (): Promise<NotificationSettings> => {
    if (isAndroid) {
      return this.native.getNotificationSettings().then(({ authorizationStatus, android }: any) => {
        return {
          authorizationStatus,
          android,
          ios: {
    ...
    if (isIOS) {
      return this.native.getNotificationSettings().then(({ authorizationStatus, ios }: any) => {
        return {
          authorizationStatus,
          ios,
          android: {
  ...
  public getPowerManagerInfo = (): Promise<PowerManagerInfo> => {
    ...
    return this.native.getPowerManagerInfo() as unknown as Promise<PowerManagerInfo>;
  };
