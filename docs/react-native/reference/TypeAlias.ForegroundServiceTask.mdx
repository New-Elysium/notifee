...
[@psync/notifee](react-native/reference/index) / ForegroundServiceTask

# Type Alias: ForegroundServiceTask

> **ForegroundServiceTask** = (`notification`) => `Promise`<`void`>

Defined in: [packages/react-native/src/types/Notification.ts:191](https://github.com/New-Elysium/notifee/blob/main/packages/react-native/src/types/Notification.ts#L191)
