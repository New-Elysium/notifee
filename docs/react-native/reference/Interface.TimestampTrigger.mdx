...
Defined in: [packages/react-native/src/types/Trigger.ts:34](https://github.com/New-Elysium/notifee/blob/main/packages/react-native/src/types/Trigger.ts#L34)
...
Defined in: [packages/react-native/src/types/Trigger.ts:25](https://github.com/New-Elysium/notifee/blob/main/packages/react-native/src/types/Trigger.ts#L25)
