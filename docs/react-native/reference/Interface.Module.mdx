...
[@psync/notifee](react-native/reference/index) / Module

# Interface: Module

Defined in: [packages/react-native/src/types/Module.ts:19](https://github.com/New-Elysium/notifee/blob/main/packages/react-native/src/types/Module.ts#L19)
