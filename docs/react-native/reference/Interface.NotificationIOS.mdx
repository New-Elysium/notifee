...
Defined in: [packages/react-native/src/types/NotificationIOS.ts:125](https://github.com/New-Elysium/notifee/blob/main/packages/react-native/src/types/NotificationIOS.ts#L125)
