...
Notifee provides a handy [event](/react-native/events) listener to subscribe to all incoming notification and device events.
...
To learn more about handling events in your application, view the [events](/react-native/events) documentation.
