...
<Vimeo id="385504344" caption="Android Big Picture Style" />

To implement this style, we provide the `AndroidStyle.BIGPICTURE` to the `style` object:

```js
import notifee, { AndroidStyle } from '@psync/notifee';
...
<Vimeo id="385509335" caption="Android Big Text Style" />
...
<Vimeo id="385939542" caption="Android Inbox Style" />
...
<Vimeo id="385940932" caption="Android Messaging Style" />
