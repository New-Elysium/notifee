...
> To use custom sounds on iOS, view the [iOS Sound](/react-native/ios/behaviour#sound) documentation for details.
...
```js
import notifee, { AndroidColor } from '@psync/notifee';
// Android >= 8.0 (API level 26)
notifee.createChannel({
  id: 'custom-lights',
...
[Foreground Service](/react-native/android/foreground-service)). It is possible to disable this functionality by
...
<Vimeo id="385475992" caption="Android Ongoing Notification" />
...
To learn more about these concepts, view the [Press Action](/react-native/android/interaction#press-action) documentation.
