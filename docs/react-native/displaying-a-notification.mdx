...
basic notification inside of a React Native app when a button is pressed. Import the library and display a basic view with a [`Button`](https://facebook.github.io/react-native/docs/button):
...
> To learn more about requesting permissions, view the [iOS Permissions](/react-native/ios/permissions) documentation
...
> To learn more about channels and small icons, view the [Android Channels](/react-native/android/channels) and [Small Icon](/react-native/android/appearance#small-icons) documentation.
